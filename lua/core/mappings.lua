...
if is_available "telescope.nvim" then
  maps.n["gr"] = { function() require("telescope.builtin").lsp_references() end, desc = "Get references" }
  maps.n["gd"] = { function() require("telescope.builtin").lsp_definitions() end, desc = "Get to definition" }
